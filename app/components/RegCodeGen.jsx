...
export default function RegCodeGen() {
  ...
  const [recipientName, setRecipientName] = useState(""); // ⭐ New state for the name
  ...
  const fetchCodes = async () => {
    const q = query(collection(db, "reg_codes"), orderBy("createdAt", "desc"));
